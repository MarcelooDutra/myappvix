        ...
        <div className="flex min-h-screen bg-[#0b1120] relative">
            ...
            <main className="flex-1 h-screen overflow-y-auto relative">
                ...
                <div className="p-4 md:p-8 pb-24">
                    ...
                    {/* LISTA DE PRODUTOS */}
                    <div className="bg-[#1e293b] rounded-2xl border border-slate-700/50 shadow-xl overflow-hidden flex flex-col h-full max-h-[600px]"> {/* 1. Defini uma altura máxima aqui */}

                        <div className="p-6 border-b border-slate-700/50 shrink-0">
                            <h3 className="text-xl font-bold text-white">Gerenciar Estoque</h3>
                        </div>

                        {/* 2. Adicionei overflow-y-auto aqui para criar a barra de rolagem vertical */}
                        <div className="overflow-x-auto overflow-y-auto">
                            <table className="w-full text-left min-w-[600px]">
                                {/* 3. Adicionei 'sticky top-0 z-10' para o cabeçalho ficar travado no topo */}
                                <thead className="bg-[#0f172a] text-slate-400 text-sm uppercase tracking-wider sticky top-0 z-10">
                                    <tr>
                                    ...
                                    {produtos.map((prod) => {
                                        ...
                                        return (
                                            <tr key={prod.id} className={`transition ${vendido ? 'bg-slate-800/30 opacity-50' : 'hover:bg-slate-800/50'}`}>
                                                {/* ... (conteúdo das células continua igual) ... */}
